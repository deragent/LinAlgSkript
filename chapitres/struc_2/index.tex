...
\paragraph{Example} La soustraction ($-$) sur $\Z$ n'est ni associative ni commutative ni unifère. ($0$ est élément neutre à droit mais pas à gauche $\rightarrow$ $0 - x = x \neq x - 0$.)
...
\paragraph{Example}  $(\Z, +, \times), (\R, +, \times)$ sont des anneaux commutatifs.
