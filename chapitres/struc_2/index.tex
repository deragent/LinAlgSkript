...
\paragraph{} On rapelle que si $E$ est un ensemble, une loi de composition interne $\star$ sur $E$ est une application:
\begin{eqnarray*}
\star{}: & E \times E \rightarrow E \\
& (x, y) \mapsto x \star y
\end{eqnarray*}

\paragraph{} Soit E un ensemble muni d'une loi de composition interne $\star$. On dit que $\star$ est associative si
...
\paragraph{} On dit que $\star$ est commutative si
$$ \forall x, y \in E, x \star y = y \star x$$

\paragraph{} On dit que $\star$ est unifié si $E$ posséde un élément neutre pour $\star$, c'est-à-dire un élément tel que
$$ \forall x \in E, e \star x = x = x \star e$$
Cet élément neutre, s'il existe, est unique.
%Vielleicht Beweis einfügen

\paragraph{} Ons uppose que $\star$ est unifière d'élément neutre e. Soit $x \in E$. On dit qu'un élément $y \in E$ est un symétrique de $x$ pour $\star$ si
$$ x \star y = e = y \star x$$
...
\paragraph{Définition} Soient $(A, +, \times)$ un anneaux et $x \in A$. On dit que $x$ est un élément inversible de $A$, si $A$ admet un enverse pour $x$. On note $A^{x}$ l'ensemble des éléments inversibles de $A$. L'ensemble $A^{x}$ muni de $\times$ est un groupe.
...
\paragraph{Définition} Soient $(U, +, \cdot)$ et $(V, +, \cdot)$ deux $\R$-espace vectoriels. Un morphisme de $\R$-espace vectoriels de $U$ dans $V$ est und application linéaire
  $$f: U \rightarrow V$$
  telle que
  \begin{eqnarray*}
