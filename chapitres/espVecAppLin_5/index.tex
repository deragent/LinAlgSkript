...
\paragraph{Exemple} 
\begin{itemize}
  \item Dans $\R^3$, $\vec{u} = (1, 0, 0)$, $\vec{v} = (0, 2, 3)$ $ ~ \Rightarrow ~ card((\vec{u}, \vec{v})) = 2$
  \item Dans $\R^2$, $\vec{u} = (1, 0)$, $\vec{v} = (0, 1)$, $\vec{w} = (1, 0) = \vec{u}$ $ ~ \Rightarrow ~ card((\vec{u}, \vec{v}, \vec{w})) = 3$
\end{itemize}
